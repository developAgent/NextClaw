...
pub async fn list_files(
    ...
    // Record operation
    let operation = FileOperation::new(session_id, FileOperationType::List, path.clone());
    save_file_operation(&db, &operation).await?;
...
pub async fn read_file(
    ...
    // Record operation
    let operation = FileOperation::new(session_id, FileOperationType::Read, path.clone());
    save_file_operation(&db, &operation).await?;
...
pub async fn write_file(
    ...
    // Record operation
    let operation = FileOperation::new(session_id, FileOperationType::Write, path.clone());
    save_file_operation(&db, &operation).await?;
...
/// Get file metadata
#[tauri::command]
pub async fn get_file_metadata(path: String) -> Result<FileMetadata> {
...
pub async fn delete_file(
    ...
    // Record operation
    let operation = FileOperation::new(session_id, FileOperationType::Delete, path.clone());
    save_file_operation(&db, &operation).await?;
...
async fn save_file_operation(db: &Database, operation: &FileOperation) -> Result<()> {
    db.execute(
        r#"
